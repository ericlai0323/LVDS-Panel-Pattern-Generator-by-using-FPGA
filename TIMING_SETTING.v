...
// Horizontal timing
`define HS_PULSE_WIDTH      22'd120
`define HS_PERIOD           22'd2512

// Vertical timing
`define VS_PULSE_WIDTH      22'd2
`define VS_PERIOD           22'd729

`define PIXEL_CLK (`HS_PERIOD * `VS_PERIOD * 60)

`ifdef HV_MODE
`define HS_BACK_PORCH   22'd200
`define VS_BACK_PORCH   22'd4
`endif
...
`define IS_CHECKER_PAT      8'd23
`define LUSTER_20P          8'd24
`define LUSTER_L64          8'd25
`define LUSTER_L32          8'd26


////////////////////////////////////////////////////////////////////////////////
// Aging & Special Patterns
// Unused Patterns = 8'd66
////////////////////////////////////////////////////////////////////////////////
`define GB_PAT              8'd66
`define RB_PAT              8'd66
`define RG_PAT              8'd66
...
`define RESPONSE_PAT_0_5s   8'd66

`define LUSTER_L10          8'd66
`define LUSTER_L22          8'd66
...
`define RGBW_GRAY_PAT       8'd66
`define CHESS_PAT_V1        8'd66
